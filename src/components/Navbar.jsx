      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="h-16 sm:h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            {/* Instagram Link CTA (Logo only) */}
            <a
              href="https://www.instagram.com/anekakuerahayu"
              target="_blank"
              rel="noopener noreferrer"
              className="p-2 sm:p-2.5 rounded-full bg-[#faf2ee] hover:bg-[#f4ece8] text-[#e1306c] active:scale-95 transition-all border border-[#eee7e3] flex items-center justify-center"
              title="Instagram @anekakuerahayu"
